...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/03/12 18:12:09 by mannette          #+#    #+#              #
#    Updated: 2019/05/06 17:55:04 by mannette         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c ft_memcmp.c\
		...
		ft_lstmap.c ft_lstiter.c ft_swap.c ft_is_power.c ft_words.c ft_free.c ft_isupper.c
...
$(NAME): $(SRCS)
	gcc -c -Wall -Wextra -Werror $(SRCS) -I libft.h
	ar rc $(NAME) $(OBJECTS)
	ranlib $(NAME)
